 ...
 * DAO for table "face".
*/
public class FaceDBDao extends AbstractDao<FaceDB, Long> {

    public static final String TABLENAME = "face";

    /**
     * Properties of entity FaceDB.<br/>
    ...
    public FaceDBDao(DaoConfig config) {
        super(config);
    }
    
    public FaceDBDao(DaoConfig config, DaoSession daoSession) {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, FaceDB entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, FaceDB entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(FaceDB entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(FaceDB entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(FaceDB entity) {
